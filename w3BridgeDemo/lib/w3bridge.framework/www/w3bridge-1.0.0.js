...
View.prototype.open = function(url, method, options) {
  if (method == "browser") {
        ...
        var _options = {scrollEnabled: 1, hidesBottomBarWhenPushed: 0, landscape: 0, leftBarButtonItemText: "null", modalTransitionStyle: 0, title: "null", refreshEnabled: 1, closeEnabled: 1};
  	for (var name in options)
  		_options[name] = options[name];
  
  	if (method == "push") {
  		navigator.bridge.view.pushWithURL(url, _options.scrollEnabled, _options.hidesBottomBarWhenPushed, _options.landscape, _options.leftBarButtonItemText, _options.title, _options.refreshEnabled, _options.closeEnabled);
  	} else if (method == "pop") {
  		navigator.bridge.view.popWithURL(url, _options.scrollEnabled, _options.landscape, _options.leftBarButtonItemText, _options.modalTransitionStyle, _options.title, _options.refreshEnabled, _options.closeEnabled);
  	}
	}
};
...
View.prototype.pushWithURL = function(url, scrollEnabled, hidesBottomBarWhenPushed, landscape, leftBarButtonItemText, title, refreshEnabled, closeEnabled) {
    if (Cordova.isValidPlatform()) {
    	...
    	var _refreshEnabled = refreshEnabled == undefined || refreshEnabled == null ? 1 : refreshEnabled;
    	var _closeEnabled = closeEnabled == undefined || closeEnabled == null ? 1 : closeEnabled;
        Cordova.exec(null, null, "org.apache.w3bridge.view", "pushWithURL",
        	[url, _scrollEnabled, _hidesBottomBarWhenPushed, _landscape, leftBarButtonItemText, title, _refreshEnabled, _closeEnabled]);
    } else {
    	window.location.href = url;
    }
};
...
View.prototype.popWithURL = function(url, scrollEnabled, landscape, leftBarButtonItemText, modalTransitionStyle, title, refreshEnabled, closeEnabled) {
    if (Cordova.isValidPlatform()) {
    	var _scrollEnabled = scrollEnabled == undefined || scrollEnabled == null ? 1 : scrollEnabled;
    	var _landscape = landscape == undefined || landscape == null ? 0 : landscape;
    	var _refreshEnabled = refreshEnabled == undefined || refreshEnabled == null ? 1 : refreshEnabled;
        ...
        Cordova.exec(null, null, "org.apache.w3bridge.view", "popWithURL",
        	[url, _scrollEnabled, _landscape, leftBarButtonItemText, modalTransitionStyle, title, _refreshEnabled, _closeEnabled]);
    } else {
    	window.location.href = url;
    }
};
...
View.prototype.setRightBarButtonItem = function(text, callback) {
	if (Cordova.isValidPlatform()) {
        Cordova.exec(null, null, "org.apache.w3bridge.view", "setRightBarButtonItem", [text, callback]);
	}
};
